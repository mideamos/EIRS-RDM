    ...
    public class LandRepository : ILandRepository
    {
        ...
        public IDictionary<string, object> REP_SearchLand(Land pObjLand)
        {
            using (_db = new EIRSEntities())
            {
                ...
                {
                    new SqlParameter("@MainFilter",pObjLand.MainFilter??(object) DBNull.Value),
                    new SqlParameter("@LandRIN",pObjLand.LandRIN ??(object) DBNull.Value),
                    new SqlParameter("@PlotNumber",pObjLand.PlotNumber ??(object) DBNull.Value),
                    new SqlParameter("@StreetName",pObjLand.StreetName ??(object) DBNull.Value),
                    new SqlParameter("@TownName",pObjLand.TownName ??(object) DBNull.Value),
                    new SqlParameter("@LGAName",pObjLand.LGAName ??(object) DBNull.Value),
                    new SqlParameter("@WardName",pObjLand.WardName ??(object) DBNull.Value),
                    new SqlParameter("@LandSize_Length",pObjLand.strLandSize_Length ??(object) DBNull.Value),
                    new SqlParameter("@LandSize_Width",pObjLand.strLandSize_Width ??(object) DBNull.Value),
                    new SqlParameter("@C_OF_O_Ref",pObjLand.C_OF_O_Ref ??(object) DBNull.Value),
                    new SqlParameter("@LandPurposeName",pObjLand.LandPurposeName ??(object) DBNull.Value),
                    new SqlParameter("@LandFunctionName",pObjLand.LandFunctionName ??(object) DBNull.Value),
                    new SqlParameter("@LandOwnershipName",pObjLand.LandOwnershipName ??(object) DBNull.Value),
                    new SqlParameter("@LandDevelopmentName",pObjLand.LandDevelopmentName ??(object) DBNull.Value),
                    new SqlParameter("@Latitude",pObjLand.Latitude ??(object) DBNull.Value),
                    new SqlParameter("@Longitude",pObjLand.Longitude ??(object) DBNull.Value),
                    new SqlParameter("@LandStreetConditionName",pObjLand.LandStreetConditionName ??(object) DBNull.Value),
                    new SqlParameter("@ValueOfLand",pObjLand.strValueOfLand ??(object) DBNull.Value),
                    new SqlParameter("@Neighborhood",pObjLand.Neighborhood ??(object) DBNull.Value),
                    new SqlParameter("@ActiveText",pObjLand.ActiveText ??(object) DBNull.Value)
                };
