...
namespace EIRS.BLL
{
    public class BLBusiness
    {
        ...
        public IList<usp_GetBusinessList_Result> BL_GetBusinessList(Business pObjBusiness)
        {
        ...
        public usp_GetBusinessList_Result BL_GetBusinessDetails(Business pObjBusiness)
        {
